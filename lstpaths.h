...
#define LSTPATHS_H
    ...
    #define     _FILENAME_LAST_SNAPSHOT              "./settings/lastSnapshot.hypparam"
    ...
    #define _PATH_REMOTE_SLIDESETTINGS      "./tmpSettings/slideSettings.xml"
    ...
    #define _PATH_LOCAL_SLIDESETTINGS   "./XML/slideDiffraction.xml"
